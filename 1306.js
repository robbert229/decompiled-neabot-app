var n,
  ...
  S = ReactNative.UIManager,
  y = ReactNative.requireNativeComponent('RNCWebView'),
  ...
  L = (function (t) {
    ...
    n.prototype.render = function () {
      var t = this.props,
        ...
        R = null;
      if ('LOADING' === this.state.viewState) R = (w || module1307.defaultRenderLoading)();
        ...
        R = (v || module1307.defaultRenderError)(O.domain, O.code, O.description);
      } else 'IDLE' !== this.state.viewState && console.error('RNCWebView invalid state encountered: ' + this.state.viewState);
      var H = [module1309.default.container, module1309.default.webView, C],
        N = [module1309.default.container, L];
      ...
      var P = W.component || y;
      this.onShouldStartLoadWithRequest = module1307.createOnShouldStartLoadWithRequest(this.onShouldStartLoadWithRequestCallback, h, u);
    ...
    n.defaultProps = {
      ...
      originWhitelist: module1307.defaultOriginWhitelist,
    };
