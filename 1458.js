...
function h(t, n, o) {
  ...
  if (Q(t, ArrayBuffer) || (t && Q(t.buffer, ArrayBuffer))) return b(t, n, o);
  if ('undefined' != typeof SharedArrayBuffer && (Q(t, SharedArrayBuffer) || (t && Q(t.buffer, SharedArrayBuffer)))) return b(t, n, o);
  if ('number' == typeof t) throw new TypeError('The "value" argument must not be of type number. Received type number');
  var f = t.valueOf && t.valueOf();
  if (null != f && f !== t) return s.from(f, n, o);
  var u = E(t);
  if (u) return u;
  if ('undefined' != typeof Symbol && null != Symbol.toPrimitive && 'function' == typeof t[Symbol.toPrimitive]) return s.from(t[Symbol.toPrimitive]('string'), n, o);
...
function w(t) {
  for (var n = t.length < 0 ? 0 : 0 | B(t.length), o = u(n), f = 0; f < n; f += 1) o[f] = 255 & t[f];
...
function E(t) {
  ...
  if (undefined !== t.length) return 'number' != typeof t.length || tt(t.length) ? u(0) : w(t);
...
function I(t, n, o, f, u) {
  ...
  if (('string' == typeof module638 && (module638 = s.from(module638, f)), s.isBuffer(module638))) return 0 === module638.length ? -1 : L(t, module638, o, f, u);

  if ('number' == typeof module638) {
    module638 &= 255;
    return 'function' == typeof Uint8Array.prototype.indexOf
      ? u
        ? Uint8Array.prototype.indexOf.call(t, module638, o)
        : Uint8Array.prototype.lastIndexOf.call(t, module638, o)
      : L(t, [module638], o, f, u);
  }
...
s.compare = function (t, n) {
  if ((Q(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), Q(n, Uint8Array) && (n = s.from(n, n.offset, n.byteLength)), !s.isBuffer(t) || !s.isBuffer(n)))
...
s.concat = function (t, n) {
  ...
  for (o = 0; o < t.length; ++o) {
    var h = t[o];
    if (Q(h, Uint8Array)) u + h.length > f.length ? s.from(h).copy(f, u) : Uint8Array.prototype.set.call(f, h, u);
    else {
      if (!s.isBuffer(h)) throw new TypeError('"list" argument must be an Array of Buffers');
      h.copy(f, u);
    }
    u += h.length;
  }
...
s.prototype.swap16 = function () {
  ...
  for (var n = 0; n < t; n += 2) T(this, n, n + 1);
...
s.prototype.toString = function () {
  var t = this.length;
  return 0 === t ? '' : 0 === arguments.length ? k(this, 0, t) : U.apply(this, arguments);
};
...
s.prototype.compare = function (t, n, o, f, u) {
  if ((Q(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), !s.isBuffer(t)))
...
s.prototype.readUintLE = s.prototype.readUIntLE = function (t, n, o) {
  t >>>= 0;
  n >>>= 0;
...
s.prototype.readUintBE = s.prototype.readUIntBE = function (t, n, o) {
  t >>>= 0;
  n >>>= 0;
  if (!o) N(t, n, this.length);
...
s.prototype.readFloatLE = function (t, o) {
  ...
  return module638.read(this, base64js, true, 23, 4);
};

s.prototype.readFloatBE = function (t, o) {
  base64js >>>= 0;
  if (!o) N(base64js, 4, this.length);
  return module638.read(this, base64js, false, 23, 4);
};

s.prototype.readDoubleLE = function (t, o) {
  base64js >>>= 0;
  if (!o) N(base64js, 8, this.length);
  return module638.read(this, base64js, true, 52, 8);
};

s.prototype.readDoubleBE = function (t, o) {
  base64js >>>= 0;
  if (!o) N(base64js, 8, this.length);
  return module638.read(this, base64js, false, 52, 8);
};

s.prototype.writeUintLE = s.prototype.writeUIntLE = function (t, n, o, f) {
...
s.prototype.writeUintBE = s.prototype.writeUIntBE = function (t, n, o, f) {
  if (!((t = +t), (n >>>= 0), (o >>>= 0), f)) Y(this, t, n, o, 2 ** (8 * o) - 1, 0);
  var u = o - 1,
    s = 1;
...
s.prototype.writeUint8 = s.prototype.writeUInt8 = function (t, n, o) {
  base64js = +base64js;
  module638 >>>= 0;
  if (!o) Y(this, base64js, module638, 1, 255, 0);
  this[module638] = 255 & base64js;
  return module638 + 1;
};

s.prototype.writeUint16LE = s.prototype.writeUInt16LE = function (t, n, o) {
  base64js = +base64js;
  module638 >>>= 0;
  if (!o) Y(this, base64js, module638, 2, 65535, 0);
  this[module638] = 255 & base64js;
  this[module638 + 1] = base64js >>> 8;
  return module638 + 2;
};

s.prototype.writeUint16BE = s.prototype.writeUInt16BE = function (t, n, o) {
  base64js = +base64js;
  module638 >>>= 0;
  if (!o) Y(this, base64js, module638, 2, 65535, 0);
  this[module638] = base64js >>> 8;
  this[module638 + 1] = 255 & base64js;
  return module638 + 2;
};

s.prototype.writeUint32LE = s.prototype.writeUInt32LE = function (t, n, o) {
  base64js = +base64js;
  module638 >>>= 0;
  if (!o) Y(this, base64js, module638, 4, 4294967295, 0);
  this[module638 + 3] = base64js >>> 24;
  this[module638 + 2] = base64js >>> 16;
  this[module638 + 1] = base64js >>> 8;
  this[module638] = 255 & base64js;
  return module638 + 4;
};

s.prototype.writeUint32BE = s.prototype.writeUInt32BE = function (t, n, o) {
  base64js = +base64js;
  module638 >>>= 0;
  if (!o) Y(this, base64js, module638, 4, 4294967295, 0);
  this[module638] = base64js >>> 24;
  this[module638 + 1] = base64js >>> 16;
  this[module638 + 2] = base64js >>> 8;
  this[module638 + 3] = 255 & base64js;
  return module638 + 4;
};
...
s.prototype.writeInt8 = function (t, n, o) {
  base64js = +base64js;
  module638 >>>= 0;
  if (!o) Y(this, base64js, module638, 1, 127, -128);
...
s.prototype.writeInt16LE = function (t, n, o) {
  base64js = +base64js;
  module638 >>>= 0;
  if (!o) Y(this, base64js, module638, 2, 32767, -32768);
  this[module638] = 255 & base64js;
  this[module638 + 1] = base64js >>> 8;
  return module638 + 2;
};
...
s.prototype.writeInt32LE = function (t, n, o) {
  base64js = +base64js;
  module638 >>>= 0;
  if (!o) Y(this, base64js, module638, 4, 2147483647, -2147483648);
  this[module638] = 255 & base64js;
  this[module638 + 1] = base64js >>> 8;
  this[module638 + 2] = base64js >>> 16;
  this[module638 + 3] = base64js >>> 24;
