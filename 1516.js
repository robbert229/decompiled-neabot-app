...
M[c] = M[s] = M[E] = M[l] = M[F] = M[_] = M[h] = M[p] = M[y] = M[b] = M[w] = M[A] = M[O] = M[k] = M['[object WeakMap]'] = false;

var U = 'object' == typeof globals && globals && globals.Object === Object && globals,
  B = 'object' == typeof self && self && self.Object === Object && self,
  I = U || B || Function('return this')(),
  L = 'object' == typeof exports && exports && !exports.nodeType && exports,
  T = L && 'object' == typeof module && module && !module.nodeType && module,
  W = T && T.exports === L,
  D = W && U.process,
  R = (function () {
    try {
...
var Q,
  ...
  ct = W ? I.Buffer : undefined,
  st = I.Symbol,
  ft = I.Uint8Array,
  lt = et.propertyIsEnumerable,
  _t = Z.splice,
  ht = st ? st.toStringTag : undefined,
...
function Rt(t, o, u, f, l, _) {
  ...
  return !!z && (_ || (_ = new Ut()), qt(t, o, u, f, l, _));
}
...
function qt(t, o, u, c, s, f) {
  ...
  if (b && !j) {
    var O = t.constructor,
      k = o.constructor;
    if (O != k && 'constructor' in t && 'constructor' in o && !('function' == typeof O && O instanceof O && 'function' == typeof k && k instanceof k)) b = false;
  }
...
var fe = C
  ...
  : function (t) {
      return se(t) && ue(t.length) && !!M[Tt(t)];
    };

function le(t) {
  return null != (n = t) && ue(n.length) && !ae(n) ? Bt(t) : Nt(t);
  var n;
}
