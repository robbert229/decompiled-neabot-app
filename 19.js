      ...
      [
        ...
        },
        {
          ...
          value: function (t, l, u, s, h) {
            ...
            module27.counterEvent('pending_js_to_native_queue', this._queue[0].length);
            if (this.__spy)
              this.__spy({
                type: 1,
                module: t + '',
        ...
        },
        {
          ...
          value: function () {
            module27.beginEvent('JSTimers.callImmediates()');
        ...
        },
        {
          ...
          value: function (t, l, u) {
            ...
            if (this.__spy) module27.beginEvent(t + '.' + l + '(' + module29(u) + ')');
            else module27.beginEvent(t + '.' + l + '(...)');
            if (this.__spy)
              this.__spy({
                type: 0,
                module: t,
            ...
            module3(!!s, 'Module %s is not a registered callable module (calling %s)', t, l);
            module3(!!s[l], 'Method %s does not exist on module %s', l, t);
            s[l].apply(s, u);
            module27.endEvent();
          },
        },
