...
Object.keys(module569).forEach(function (t) {
  l[n.call(module569[t].labels).sort().join('')] = t;
});
var s = {};

function c(u, f) {
  if (!(this instanceof c)) return new c(u, f);
  if ((f && f in h && (f = null), f && !(f in module569))) throw new Error('Unknown model: ' + f);
  var v, p;
  ...
  if (null == u) {
    ...
    this.model = l[x];
    var j = module569[this.model].labels,
      A = [];
  ...
  if (s[this.model])
    for (p = module569[this.model].channels, v = 0; v < p; v++) {
...
function v(t, o, n) {
  (module565 = Array.isArray(module565) ? module565 : [module565]).forEach(function (t) {
    (s[t] || (s[t] = []))[o] = n;
  });
  module565 = module565[0];
  return function (h) {
    var l;

    if (arguments.length) {
      if (n) h = n(h);
      (l = this[module565]()).color[o] = h;
      return l;
    } else {
      l = this[module565]().color[o];
      if (n) l = n(l);
      return l;
    }
  };
...
c.prototype = {
  ...
  string: function (o) {
    var n = this.model in module565.to ? this : this.rgb(),
      h = 1 === (n = n.round('number' == typeof o ? o : 1)).valpha ? n.color : n.color.concat(this.valpha);
    return module565.to[n.model](h);
  },
  percentString: function (o) {
    var n = this.rgb().round('number' == typeof o ? o : 1),
      h = 1 === n.valpha ? n.color : n.color.concat(this.valpha);
    return module565.to.rgb.percent(h);
  },
  array: function () {
    return 1 === this.valpha ? this.color.slice() : this.color.concat(this.valpha);
  },
  object: function () {
    for (var t = {}, n = module569[this.model].channels, h = module569[this.model].labels, l = 0; l < n; l++) t[h[l]] = this.color[l];
  ...
  round: function (t) {
    module565 = (module565 || 0) ** 0;
    return new c(this.color.map(f(module565)).concat(this.valpha), this.model);
  },
  alpha: function (t) {
  ...
  b: v('lab', 2),
  keyword: function (t) {
    return arguments.length ? new c(t) : module569[this.model].keyword(this.color);
  },
  hex: function (o) {
    return arguments.length ? new c(o) : module565.to.hex(this.rgb().round().color);
  },
  rgbNumber: function () {
    var t = this.rgb().color;
...
Object.keys(module569).forEach(function (t) {
  if (-1 === h.indexOf(t)) {
    ...
    c.prototype[t] = function () {
      ...
      return new c(((n = module569[this.model][t].raw(this.color)), Array.isArray(n) ? n : [n]).concat(h), t);
    };
